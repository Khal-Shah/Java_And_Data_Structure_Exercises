...
import java.util.*;
		 ...
		 * initial temperature to a final temperature. Your program should prompt the user to enter the amount of water 
		 * in kilograms and the initial and final temperatures of the water. The formula to compute the energy is
...
public class Ch2_10_Calculate_Energy
{
